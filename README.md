...
Pairs with the [`sf-ai-agentforce-voice-demo`](https://github.com/gabo3110-afk/agentforce-voice-demo-template/blob/main/docs/skill-pointer.md) Claude skill that documents the 20 runtime patterns this scaffold encodes.
